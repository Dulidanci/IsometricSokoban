package io.github.dulidanci.isometricsokoban.lwjgl3;
...
public class Lwjgl3Launcher {
    ...
    private static Lwjgl3Application createApplication() {
        return new Lwjgl3Application(IsometricSokoban.getInstance(), getDefaultConfiguration());
    }

    private static Lwjgl3ApplicationConfiguration getDefaultConfiguration() {
        Lwjgl3ApplicationConfiguration configuration = new Lwjgl3ApplicationConfiguration();
        configuration.setTitle("IsometricSokoban");
        ...
        configuration.setWindowIcon(IsometricSokoban.ID + "/textures/blocks/wall.png");
